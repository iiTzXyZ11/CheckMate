...
if platform.system() == 'Windows':
    import win32com.client  # Example Windows-specific import
    # You can add Windows-specific functionality here
    print("Running on Windows, imported win32com.client")
