        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "content": (f"Grade the following essay based on the criterion '{criterion['name']}' out of "
                            ...
                            "Do not be too strict when grading. Consider the context and criteria. ALWAYS Respond in Filipino. Make sure to not be too strict and allow for a perfect grade if the text is deserving of it."
                            f"Essay:\n{truncated_essay}\n\n"
